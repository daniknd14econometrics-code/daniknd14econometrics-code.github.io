...
![Comparación de la trayectoria WATT entre demeaning y detrending](did_m09b_event_demean_detrend.svg){fig-alt="Event study comparativo entre rolling demean y rolling detrend con IPWRA y covariables, mostrando solo estimaciones puntuales. Detrending acerca el pre a cero y reduce los efectos posteriores. Los ceros de referencia, en menos uno para demean y en menos dos y menos uno para detrend, no son evidencia estimada de ausencia de efecto."}
...
En la aplicación común, ETWFE incorpora tendencias por cohorte e interacciones con covariables dentro de la regresión. Rolling detrend estima primero la tendencia previa de cada condado, transforma el resultado y después aplica IPWRA. Los resultados ya producidos permiten comparar ambas construcciones:
