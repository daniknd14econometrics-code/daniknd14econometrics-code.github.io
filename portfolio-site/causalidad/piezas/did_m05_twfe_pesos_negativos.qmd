...
:::: {.figure-pair}
::: {.figure-pair__item}
![Entradas y salidas de afiliación sindical por año](../assets/graficos/did_m05_switchers_por_anio.png){fig-alt="Cantidad de transiciones hacia y fuera de la afiliación sindical por año."}
:::
::: {.figure-pair__item}
![Bloques DIDM por año](../assets/graficos/did_m05_didm_bloques_por_anio.png){fig-alt="Comparaciones entre switchers y stayers que integran DIDM en cada año."}
:::
::::
...
![Comparación entre DIDM manual, implementación histórica y WAS moderno](../assets/graficos/did_m05_comparacion_didm.png){fig-alt="Comparación de las estimaciones DIDM manual, DIDM histórico y WAS moderno para afiliación sindical y salarios."}
