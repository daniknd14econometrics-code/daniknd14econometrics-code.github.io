...
:::: {.figure-pair}
::: {.figure-pair__item}
![Balance antes y después de ponderar para producto y proceso frente al grupo base](../assets/graficos/c06_loveplot_teffects_t3.png){fig-alt="Love plot de diferencias estandarizadas antes y después de la ponderación para el contraste producto y proceso frente al grupo base."}
:::
::: {.figure-pair__item}
![Distribución de los pesos normalizados para producto y proceso frente al grupo base](../assets/graficos/c06_weights_norm_design_manual_t3.png){fig-alt="Distribución de pesos normalizados del diseño manual para el contraste producto y proceso frente al grupo base."}
:::
::::
...
![Coefplot horizontal de ATET diagonales (IC 95%)](../assets/graficos/6_mini_coefplot_atet_diagonales.svg)
