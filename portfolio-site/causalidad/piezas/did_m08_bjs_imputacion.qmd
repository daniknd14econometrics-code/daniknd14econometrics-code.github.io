...
:::: {.figure-pair}
::: {.figure-pair__item}
![Soporte de observaciones no tratadas por año](../assets/graficos/did_m08_soporte_untreated.png){fig-alt="Cantidad de observaciones no tratadas disponibles por año para estimar el resultado potencial sin tratamiento."}
:::
::: {.figure-pair__item}
![Soporte de tratados al excluir los nunca tratados](../assets/graficos/did_m08_soporte_sin_never.png){fig-alt="Observaciones tratadas imputables y no imputables cuando se excluye el grupo nunca tratado."}
:::
::::
...
Bajo el modelo de resultados no tratados y los supuestos del diseño, el cambio de salario mínimo produce una reducción media estimada de **0,0477 puntos logarítmicos en el empleo adolescente** entre las observaciones tratadas imputables. El agregado reúne 291 observaciones condado-año, mientras 2.209 observaciones sin tratamiento permiten ajustar el contrafactual. La cifra resume cohortes y horizontes distintos; su población objetivo no es el conjunto completo de condados ni un efecto homogéneo común.
...
*Nota:* K = −2 y K = −1 son diagnósticos de pretrends sobre observaciones no tratadas, no efectos causales pretratamiento.
...
![Soporte de observaciones tratadas por cohorte y horizonte](../assets/graficos/did_m08_soporte_cohorte_horizonte.png){fig-alt="Distribución de observaciones tratadas imputables por cohorte de adopción y horizonte relativo."}
...
![Event study BJS con controles temporales y población inicial](../assets/graficos/did_m08_event_study_timecontrols.png){fig-alt="Event study de la especificación del taller que incorpora población inicial interactuada con el tiempo al modelo de resultado no tratado."}
