...
::: {.figure-pair}
::: {.figure-pair__item}
![](../assets/08_kdensity_bandwidth_plugin_2015.png){fig-alt="Densidad kernel de 2015 con el ancho de banda plug-in"}
:::
::: {.figure-pair__item}
![](../assets/09_kdens_bandwidth_selectors_2015.png){fig-alt="Comparación de selectores de ancho de banda para la densidad de 2015"}
:::
:::
...
![](../assets/05_histograma_ventana_naive_x0_2015.png){fig-alt="Histograma de 2015 con la ventana local alrededor de la mediana ponderada" width="100%"}
