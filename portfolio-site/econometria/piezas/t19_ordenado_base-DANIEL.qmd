...
::: {.metric-note}
`Pr(cartera conservadora)=0.331`, `Pr(cartera mixta)=0.370`, `Pr(cartera más expuesta a acciones)=0.298`
:::
:::
...
Esta pieza analiza una decisión financiera ordinal: la proporción del plan previsional invertida en acciones (`pctstck`) toma tres categorías ordenadas (0% en acciones, 50% en acciones y 100% en acciones). La pregunta aplicada no es metodológica en abstracto; es cómo interpretar de forma consistente esa jerarquía en términos de probabilidades.
...
El siguiente perfil resume hacia dónde se desplaza la probabilidad entre cartera conservadora, cartera mixta y cartera más expuesta a acciones para la posibilidad de elegir método de inversión, la edad y el profit sharing.

<img src="../assets/t19_desplazamiento_ordinal.svg" alt="Perfil de desplazamiento ordinal en T19: poder elegir método de inversión y tener profit sharing reducen probabilidad en cartera conservadora y la aumentan en cartera más expuesta a acciones; la edad desplaza en sentido inverso; la cartera mixta cambia poco." width="780" style="display:block; max-width:100%; height:auto;" />
...
|---|---:|---|
| 0% en acciones (cartera conservadora) | 0.331 | Aproximadamente un tercio de la muestra se ubica en perfil conservador |
| 50% en acciones (cartera mixta) | 0.370 | Es la categoría con mayor peso promedio |
| 100% en acciones (cartera más expuesta a acciones) | 0.298 | Cerca de tres de cada diez casos se ubican en el perfil más accionario |
:::

Como objeto final de decisión, la pieza prioriza tres covariables protagonistas (posibilidad de elegir método de inversión, edad y profit sharing): en esta muestra, allí se concentra la señal narrable de reasignación de probabilidades.
