...
::: {.figure-pair}
::: {.figure-pair__item}
![](../assets/gmm_media_pml_vs_gmm.png){fig-alt="Comparación práctica entre la media estimada mediante Poisson PML y GMM"}
:::
::: {.figure-pair__item}
![](../assets/gmm_tobit_media_vs_mle.png){fig-alt="Comparación entre la media tipo Tobit estimada mediante GMM y máxima verosimilitud"}
:::
:::
