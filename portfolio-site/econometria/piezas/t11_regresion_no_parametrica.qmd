...
::: {.figure-pair}
::: {.figure-pair__item}
![](../assets/07_nw_comparacion_h.png){fig-alt="Estimaciones Nadaraya–Watson con distintos anchos de banda"}
:::
::: {.figure-pair__item}
![](../assets/08_ll_comparacion_h.png){fig-alt="Estimaciones locales lineales con distintos anchos de banda"}
:::
:::
