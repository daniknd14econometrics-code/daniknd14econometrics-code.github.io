...
::: {.figure-pair}
::: {.figure-pair__item}
![](../assets/05_between_endogenas.png){fig-alt="Variación between de las variables potencialmente endógenas en el panel de condados"}
:::
::: {.figure-pair__item}
![](../assets/06_within_endogenas.png){fig-alt="Variación within de las variables potencialmente endógenas en el panel de condados"}
:::
:::
