...
![](../assets/03_cdf_empirica_por_grupo.png){fig-alt="Funciones de distribución empíricas del ingreso laboral por grupo de participación" width="100%"}
...
::: {.figure-pair}
::: {.figure-pair__item}
![](../assets/05_perfil_qr_sin_controles.png){fig-alt="Perfil de regresión por cuantiles sin controles"}
:::
::: {.figure-pair__item}
![](../assets/06_perfil_qr_con_controles.png){fig-alt="Perfil de regresión por cuantiles con características previas"}
:::
:::
