...
::: {.figure-pair}
::: {.figure-pair__item}
![](../assets/apple_07_scatter_ecolbs_precio_relativo.png){fig-alt="Relación observada entre libras de manzanas ecológicas y precio relativo"}
:::
::: {.figure-pair__item}
![](../assets/apple_08_margins_ecoprc_tobit.png){fig-alt="Respuesta media ajustada del modelo Tobit al precio de las manzanas ecológicas"}
:::
:::
...
::: {.figure-pair}
::: {.figure-pair__item}
![](../assets/apple_10_kdensity_predicciones_media.png){fig-alt="Distribuciones de medias predichas entre modelos en la aplicación de manzanas"}
:::
::: {.figure-pair__item}
![](../assets/cps91_07_kdensity_predicciones_media.png){fig-alt="Distribuciones de medias predichas entre modelos en la aplicación de ingresos censurados"}
:::
:::
