...
| Modelo | Coef. `educ` | Error estándar | IC 95% | Lectura |
|---|---:|---:|---:|---|
| RE clásico | 0.1004 | 0.0087 | [0.0833, 0.1175] | Magnitud base en RE |
| RE robusto/cluster `nr` | 0.1004 | 0.0086 | [0.0835, 0.1172] | Modelo operativo para inferencia |
| FGLS AR(1)+hetero (contraste) | 0.1044 | 0.0038 | [0.0969, 0.1119] | Contraste paramétrico más exigente |
| Pooled OLS + cluster `nr` (referencia) | 0.0988 | 0.0089 | [0.0812, 0.1163] | Referencia previa sin estructura RE |
:::

<img src="../assets/t05_mini_ic95.svg" alt="Comparacion visual minima de la estimacion operativa RE robusto/cluster para educ con IC 95%" width="590" style="display:block; max-width:100%; height:auto;" />
...
|---|---:|---|
| Componente individual (`rho`) | 0.4600 | Heterogeneidad persistente importante |
| Test `H0: var(c_i)=0` | `Z=10.66`, `p<0.001` | Respalda tratar explícitamente la estructura panel |
