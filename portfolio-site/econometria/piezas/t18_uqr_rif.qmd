...
::: {.small-note}
**Una muestra distinta:** esta replicación no utiliza los pesos de encuesta. DFL y la descomposición RIF de los otros análisis comparan muestras de 232.784 y 170.693 observaciones con pesos CPS. Los resultados aquí no deben compararse numéricamente con aquellos como si representaran exactamente la misma población y ponderación.
:::
...
![](../assets/02_rif_mediana.png){fig-alt="Transformación RIF de las observaciones por encima y por debajo de la mediana salarial" width="100%"}
...
![RIF–Logit conserva el signo y la forma general del contraste. Las magnitudes difieren más en la cola alta; la coincidencia cualitativa no prueba correcta especificación ni identificación causal.](../assets/04_rifols_vs_riflogit.png){#fig-rif-sensibilidad fig-alt="Perfiles completos de RIF–OLS y RIF–Logit a través de la distribución salarial" width="100%"}
