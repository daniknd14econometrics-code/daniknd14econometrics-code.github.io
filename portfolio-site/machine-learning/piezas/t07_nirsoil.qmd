...
![Correlación mediana por distancia espectral, con banda P10–P90 a lo largo de toda la separación disponible.](../assets/ml_t07_03_correlacion_por_distancia_espectral.png){#fig-nirsoil-correlacion width="100%"}
...
:::: {.figure-panel}
::: {.figure-panel__item}
![Error mínimo de validación al recorrer alpha.](../assets/ml_t07_05_error_minimo_cv_por_alpha.png){width="100%"}
:::
::: {.figure-panel__item}
![Coeficientes anulados al aumentar alpha.](../assets/ml_t07_06_coeficientes_anulados_por_alpha.png){width="100%"}
:::
::::
...
![Valores observados y predichos OOF, con mayor dificultad en valores altos.](../assets/ml_t07_13_observado_vs_predicho_oof.png){width="100%"}
...
![Efecto de agrupamiento en una ventana de predictores muy correlacionados.](../assets/ml_t07_11_ventana_efecto_agrupamiento.png){width="100%"}
