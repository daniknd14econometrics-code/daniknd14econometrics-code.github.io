...
![Distribución de `children` en desarrollo: conteo no negativo, masa en cero y cola derecha.](../assets/ml_e01_01_distribucion_children_DESARROLLO.png){width="100%"}
...
![Perfil de hijos ideales comparado entre GLM Poisson, Natural Splines y GAM.](../assets/ml_e01_13_perfil_idlnchld_poisson_ns_gam.png){width="100%"}

![Calibración por deciles de los métodos comparados en test.](../assets/ml_e01_16_calibracion_deciles_test.png){width="100%"}

El perfil de edad del informe muestra que el GLM obliga a un crecimiento multiplicativo continuo de la media, mientras splines y GAM encuentran crecimiento inicial, una meseta y una leve caída en edades altas. El perfil de hijos ideales aquí mostrado también permite observar un máximo interior, algo que Ridge y Lasso no pueden crear al limitarse a contraer una pendiente lineal.
