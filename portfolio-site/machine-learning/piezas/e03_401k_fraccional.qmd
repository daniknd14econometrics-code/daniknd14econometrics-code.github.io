...
![Distribución de la tasa de participación, acotada en [0, 1] y con masa en uno.](../assets/ml_e03_01_distribucion_prate_fraccional.png){width="100%"}
...
![Comparación transversal de la deviance fraccional en test.](../assets/ml_e03_09_comparacion_test_fractional_deviance.png){#fig-e03-deviance width="100%"}
...
![Perfil predictivo de `mrate` para los métodos comparados.](../assets/ml_e03_12_perfil_predictivo_mrate.png){width="100%"}

![Calibración de la media por deciles en el test.](../assets/ml_e03_11_calibracion_media_test.png){width="100%"}
...
El perfil de `mrate` da una explicación coherente. La media logit lineal aumenta continuamente con `mrate`; splines, GAM y RF encuentran crecimiento, saturación alrededor de 2,6–2,7 y una posible reversión posterior. Los otros perfiles del informe muestran crecimiento con rendimientos decrecientes para la edad del plan y, con `ltotemp`, una relación negativa cuya intensidad cambia en el rango. Son cortes predictivos condicionados, no efectos de política.
