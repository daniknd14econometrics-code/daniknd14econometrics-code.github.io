...
![Primeros niveles y reglas del CART-1SE.](../assets/ml_t09b_09_arbol_CART_1SE_primeros_niveles.png){width="100%"}
...
![Zoom de la validación de poda alrededor del mínimo y la regla 1SE. La figura general citada dentro del gráfico pertenece al informe.](../assets/ml_t09b_07_cv_poda_zoom_minimo_y_1SE.png){width="100%"}
...
![Curvas ROC de la familia CART en el test común.](../assets/ml_t09b_12_curvas_ROC_test.png){width="100%"}
...
![Matrices de confusión de CART, Bagging y Random Forest.](../assets/t09b_spam_confusion.png){#fig-spam-confusion width="100%"}
...
![AUC, Log Loss y Brier de CART y los ensambles.](../assets/t09b_spam_metricas.png){#fig-spam-metricas width="100%"}
...
![Importancia por permutación del Random Forest.](../assets/ml_t09b_17_importancia_permutacion_RF_desarrollo.png){width="100%"}
