...
:::: {.figure-panel}
::: {.figure-panel__item}
![Geografía del valor mediano de la vivienda en desarrollo.](../assets/ml_t09a_02_mapa_valor_vivienda_desarrollo.png){width="100%"}
:::
::: {.figure-panel__item}
![Geografía de los residuos del CART-1SE en test.](../assets/ml_t09a_09_mapa_residuos_test_CART_1SE.png){width="100%"}
:::
::::
...
![Primeros niveles y reglas del CART-1SE.](../assets/ml_t09a_07_arbol_CART_1SE_primeros_niveles.png){width="100%"}
...
![Zoom de la validación de poda alrededor del mínimo y la regla 1SE. La figura general citada dentro del gráfico pertenece al informe.](../assets/ml_t09a_05b_cv_poda_zoom_minimo_y_1SE.png){width="100%"}
...
![MSE de test de CART y los ensambles.](../assets/t09a_california_desempeno.png){#fig-california-desempeno width="100%"}
...
![Importancia por permutación del Random Forest.](../assets/ml_t09a_13_importancia_permutacion_RF_desarrollo.png){width="100%"}
...
[Gradient Boosting](t10a_gradient_boosting_california.qmd) continúa con la misma base, pero cambia el mecanismo: cada árbol depende de los errores que dejó la secuencia anterior. [Spam](t09b_spam.qmd) lleva los ensambles por agregación a clasificación, donde el score debe convertirse explícitamente en una decisión y en tipos de error.
