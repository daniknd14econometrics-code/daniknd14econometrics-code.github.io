...
![Distribución de `price`: respuesta positiva, asimétrica y con cola derecha extensa.](../assets/ml_e02_01_distribucion_price.png){width="100%"}
...
![Perfil de ingreso comparado entre GLM Gamma, Natural Splines y GAM.](../assets/ml_e02_09_perfil_appinc_modelos_suaves.png){width="100%"}

![Calibración de la media por deciles para todos los métodos en test.](../assets/ml_e02_14_calibracion_media_test.png){width="100%"}
