...
![Métricas probabilísticas outer-OOF de prevalencia, Logit, Natural Splines y GAM.](../assets/t08b_oj_metricas.png){#fig-oj-metricas width="100%"}
...
:::: {.figure-panel}
::: {.figure-panel__item}
![Curvas ROC outer-OOF de los clasificadores probabilísticos.](../assets/ml_t08b_02_curvas_ROC_outer_oof.png){width="100%"}
:::
::: {.figure-panel__item}
![Calibración outer-OOF de las probabilidades de compra.](../assets/ml_t08b_03_calibracion_outer_oof.png){width="100%"}
:::
::::
...
![Estabilidad de los grados de libertad efectivos del GAM penalizado.](../assets/t08b_oj_edf.png){#fig-oj-edf width="100%"}
...
![Perfiles de probabilidad de Logit, Natural Splines y GAM penalizado.](../assets/t08b_oj_perfiles.png){#fig-oj-perfiles width="100%"}
...
[OJ con Support Vector Machines](t11_oj_svm.qmd) usa la misma base para una pregunta complementaria: si ampliar la geometría de la frontera mejora clasificación y ranking, sin tratar el decision score como probabilidad. [Concrete](t08a_concrete.qmd) muestra otro contraste: allí la misma disciplina de evaluación sí respalda una ganancia material al permitir formas funcionales no lineales.
